 ...
 */
public class LongScalarAddDoubleColumnChecked extends VectorExpression {
  ...
  public LongScalarAddDoubleColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongScalarAddDoubleColumnChecked() {
    super();
