...
/**
* VectorUDAFMaxDecimal64. Vectorized implementation for MIN/MAX aggregates for Decimal64.
*/
@Description(name = "max",
    value = "_FUNC_(expr) - Returns the maximum value of expr (vectorized, type: decimal64)")
