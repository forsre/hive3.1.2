 ...
 */
public class DoubleColSubtractLongScalarChecked extends VectorExpression {
  ...
  public DoubleColSubtractLongScalarChecked(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColSubtractLongScalarChecked() {
    super();
