 ...
 */
public class LongColMultiplyDoubleScalarChecked extends VectorExpression {
  ...
  public LongColMultiplyDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColMultiplyDoubleScalarChecked() {
    super();
