 ...
 */
public class LongColAddDoubleScalarChecked extends VectorExpression {
  ...
  public LongColAddDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColAddDoubleScalarChecked() {
    super();
