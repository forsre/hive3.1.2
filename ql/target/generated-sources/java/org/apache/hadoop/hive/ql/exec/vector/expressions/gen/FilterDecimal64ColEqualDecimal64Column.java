 ...
 */
public class FilterDecimal64ColEqualDecimal64Column extends FilterLongColEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public FilterDecimal64ColEqualDecimal64Column(int colNum1, int colNum2) {
    super(colNum1, colNum2);
  }

  public FilterDecimal64ColEqualDecimal64Column() {
    super();
  }
