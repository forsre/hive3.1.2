 ...
 */
public class LongScalarAddLongColumnChecked extends VectorExpression {
  ...
  public LongScalarAddLongColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongScalarAddLongColumnChecked() {
    super();
