 ...
 */
public class DoubleColMultiplyDoubleScalarChecked extends VectorExpression {
  ...
  public DoubleColMultiplyDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColMultiplyDoubleScalarChecked() {
    super();
