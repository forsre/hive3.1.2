 ...
 */
public class DoubleColSubtractDoubleScalarChecked extends VectorExpression {
  ...
  public DoubleColSubtractDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColSubtractDoubleScalarChecked() {
    super();
