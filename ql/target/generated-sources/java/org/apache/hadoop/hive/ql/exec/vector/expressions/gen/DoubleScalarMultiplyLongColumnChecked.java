 ...
 */
public class DoubleScalarMultiplyLongColumnChecked extends VectorExpression {
  ...
  public DoubleScalarMultiplyLongColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleScalarMultiplyLongColumnChecked() {
    super();
