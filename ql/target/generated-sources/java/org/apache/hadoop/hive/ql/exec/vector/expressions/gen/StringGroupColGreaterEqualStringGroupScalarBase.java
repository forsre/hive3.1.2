...
public abstract class StringGroupColGreaterEqualStringGroupScalarBase extends VectorExpression {
  ...
  public StringGroupColGreaterEqualStringGroupScalarBase(int colNum, byte[] value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public StringGroupColGreaterEqualStringGroupScalarBase() {
    super();
