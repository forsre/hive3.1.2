 ...
 */
public class DoubleColModuloDoubleScalarChecked extends VectorExpression {
  ...
  public DoubleColModuloDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColModuloDoubleScalarChecked() {
    super();
