 ...
 */
public class LongScalarMultiplyDoubleColumnChecked extends VectorExpression {
  ...
  public LongScalarMultiplyDoubleColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongScalarMultiplyDoubleColumnChecked() {
    super();
