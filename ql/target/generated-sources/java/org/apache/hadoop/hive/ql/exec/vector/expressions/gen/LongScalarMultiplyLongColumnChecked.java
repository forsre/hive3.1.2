 ...
 */
public class LongScalarMultiplyLongColumnChecked extends VectorExpression {
  ...
  public LongScalarMultiplyLongColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongScalarMultiplyLongColumnChecked() {
    super();
