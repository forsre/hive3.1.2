...
/**
* VectorUDAFVarDecimal. Vectorized implementation for VARIANCE aggregates.
*/
...
public class VectorUDAFVarDecimal extends VectorAggregateExpression {
  ...
  public VectorUDAFVarDecimal() {
    super();
  }

  public VectorUDAFVarDecimal(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
