 ...
 */
public class LongColModuloLongScalarChecked extends VectorExpression {
  ...
  public LongColModuloLongScalarChecked(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColModuloLongScalarChecked() {
    super();
