 ...
 */
public class LongColModuloDoubleScalarChecked extends VectorExpression {
  ...
  public LongColModuloDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColModuloDoubleScalarChecked() {
    super();
