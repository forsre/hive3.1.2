 ...
 */
public class DoubleScalarAddLongColumnChecked extends VectorExpression {
  ...
  public DoubleScalarAddLongColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleScalarAddLongColumnChecked() {
    super();
