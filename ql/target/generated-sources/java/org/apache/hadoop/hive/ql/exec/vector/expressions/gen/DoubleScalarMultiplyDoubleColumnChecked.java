 ...
 */
public class DoubleScalarMultiplyDoubleColumnChecked extends VectorExpression {
  ...
  public DoubleScalarMultiplyDoubleColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleScalarMultiplyDoubleColumnChecked() {
    super();
