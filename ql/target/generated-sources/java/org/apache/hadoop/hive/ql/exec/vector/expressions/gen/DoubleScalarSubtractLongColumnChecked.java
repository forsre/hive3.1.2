 ...
 */
public class DoubleScalarSubtractLongColumnChecked extends VectorExpression {
  ...
  public DoubleScalarSubtractLongColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleScalarSubtractLongColumnChecked() {
    super();
