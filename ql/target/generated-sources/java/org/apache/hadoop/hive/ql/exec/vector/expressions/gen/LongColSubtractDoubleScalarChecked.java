 ...
 */
public class LongColSubtractDoubleScalarChecked extends VectorExpression {
  ...
  public LongColSubtractDoubleScalarChecked(int colNum, double value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColSubtractDoubleScalarChecked() {
    super();
