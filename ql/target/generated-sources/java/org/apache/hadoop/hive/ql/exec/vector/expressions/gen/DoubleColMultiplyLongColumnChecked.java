 ...
 */
public class DoubleColMultiplyLongColumnChecked extends VectorExpression {
  ...
  public DoubleColMultiplyLongColumnChecked(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public DoubleColMultiplyLongColumnChecked() {
    super();
