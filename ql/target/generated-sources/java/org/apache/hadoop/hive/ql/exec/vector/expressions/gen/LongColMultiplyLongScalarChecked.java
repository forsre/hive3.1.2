 ...
 */
public class LongColMultiplyLongScalarChecked extends VectorExpression {
  ...
  public LongColMultiplyLongScalarChecked(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongColMultiplyLongScalarChecked() {
    super();
