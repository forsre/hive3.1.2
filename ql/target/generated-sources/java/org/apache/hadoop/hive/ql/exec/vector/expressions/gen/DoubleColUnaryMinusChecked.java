 ...
 */
public class DoubleColUnaryMinusChecked extends VectorExpression {

  private static final long serialVersionUID = 1L;

  private final int colNum;

  public DoubleColUnaryMinusChecked(int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
  }

  public DoubleColUnaryMinusChecked() {
    super();
