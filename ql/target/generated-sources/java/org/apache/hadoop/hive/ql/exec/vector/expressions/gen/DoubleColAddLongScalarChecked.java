 ...
 */
public class DoubleColAddLongScalarChecked extends VectorExpression {
  ...
  public DoubleColAddLongScalarChecked(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColAddLongScalarChecked() {
    super();
