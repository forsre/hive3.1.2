 ...
 */
public class LongScalarSubtractLongColumnChecked extends VectorExpression {
  ...
  public LongScalarSubtractLongColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public LongScalarSubtractLongColumnChecked() {
    super();
