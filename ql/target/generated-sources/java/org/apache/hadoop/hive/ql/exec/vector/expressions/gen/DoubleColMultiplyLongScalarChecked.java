 ...
 */
public class DoubleColMultiplyLongScalarChecked extends VectorExpression {
  ...
  public DoubleColMultiplyLongScalarChecked(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public DoubleColMultiplyLongScalarChecked() {
    super();
